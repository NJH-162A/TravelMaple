...
builder.Services.AddIdentityCore<TravelMapleUserReal>(options => options.SignIn.RequireConfirmedAccount = true)
    .AddRoles<IdentityRole>()
    .AddEntityFrameworkStores<TravelMapleContext>()
    .AddSignInManager()
    .AddDefaultTokenProviders();
    

builder.Services.AddSingleton<IEmailSender<TravelMapleUserReal>, IdentityNoOpEmailSender>();
